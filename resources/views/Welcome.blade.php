...
<div class="carousel slide" id="carouselExampleIndicators" >
  ...
  <div class="carousel-inner mx-auto bg-dark">
    ...
    <div class="carousel-item">
      <img class="d-block w-90 mx-auto" src="https://images.unsplash.com/photo-1543443374-b6fe10a6ab7b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="...">
    </div>
    <div class="carousel-item">
      <img class="d-block w-90 mx-auto" src="https://images.unsplash.com/photo-1673042872461-674af7154d3b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1031&q=80" alt="...">
    </div>
  </div>
...
<div class="row d-flex justify-content-center">
  ...
  <div class="card-body">
    ...
    <a class="menu__item" href="{{route('produto.show', $produto->PRODUTO_ID)}}">Saiba mais</a>
</div>
